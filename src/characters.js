...
// ============================================================================
// المجلس / THE HANGOUT — a scripted group scene from the original chat.
// Every جلسة follows the same stages without anyone planning it:
//   وليد opens a topic from nowhere → أحمد flips it → نامبوي is silent then
//   ends it in one sentence → بدر reads the room and balances → عمر/سعود
//   ground it → لوفاتو lands the closing line.
// Each entry is [speakerId, text]. The engine walks them with a delay.
// ============================================================================
export const MAJLIS_SCENES = [
  [
    ["waleed", "سؤال يغير حياتكم: لو تقدر تحذف إحساس واحد للأبد، وش تحذف؟"],
    ["ahmed", "الملل! لا لا... الخوف. لا، إذا حذفت الخوف بيروح معه الحماس صح؟"],
    ["namboy", "احذف السؤال نفسه. يوفّر علينا نص ساعة."],
    ["badr", "خخخ، بس شوفوا عمر، صار يفكر بجد. عمر؟"],
    ["omar", "كنت بس أفكر إن ريحة القهوة أحلى من أي إحساس نحذفه."],
    ["saud", "صح. — وجبتها لكم، حياكم."],
    ["lovato", "خلاص، الجواب: ما نحذف شي. كله يعني شي."]
  ],
  [
    ["waleed", "الكبسة أحسن من البيتزا. حقيقة علمية. ناقشوني."],
    ["ahmed", "تقنياً البيتزا كبسة مسطحة... لا انتظروا هذا يغير كل شي عندي."],
    ["namboy", "الاثنين رز وعجين. انتهى النقاش. كلوا."],
    ["badr", "أنا طابخ لكم الثنتين الليلة، بطلوا خصام."],
    ["saud", "بدر، خليني أساعدك. الباقي يقعدون."],
    ["lovato", "حسيت إن النقاش كان عن شي ثاني، مو الأكل."]
  ],
  [
    ["waleed", "لو الوعي محاكاة، يعني نقدر نغش النظام، صح؟"],
    ["ahmed", "وإذا غششنا النظام وحسينا بذنب... يعني الذنب جزء من المحاكاة؟"],
    ["namboy", "أنتم تغشّون نفسكم من نص ساعة. كفى."],
    ["omar", "أنا فاهم نص الكلام بس مبسوط إني هني."],
    ["badr", "وهذا أهم شي يا عمر. الكل مبسوط؟"],
    ["lovato", "الجلسة هذي بالذات... نتذكرها بعدين."]
  ]
];
